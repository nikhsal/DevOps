Project present in GitHUB at https://github.com/nikhsal/DockerClientServer
...
3) Server folder contains the Dockerfile for Server, the program which will run inside the container and a random text file
